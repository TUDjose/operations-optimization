...
# Here I am using numbers for indices instead of letters, using the following sequence:
# y_0 = y_A, y_1 = y_B etc.
# Also, the upper bound of each y variable could be lowered keeping into
# consideration precedence constraints (for example, if we want tp complete the project
